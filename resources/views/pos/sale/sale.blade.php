...
<label for="offcanvas-toggle" style="position: fixed; font-size:20px; top: 59px; right: 20px; z-index: 1000; cursor: pointer;">
    <i class="fas fa-cog text-primary"></i>
</label>
    <div class="row mt-0">

        <div class="{{ $invoice_payment == 1 ? 'col-lg-8' : 'col-lg-12' }} grid-margin stretch-card mb-3">
            <div class="card">
                        ...
                        @if ($affiliateProgram)
                            <div class="mb-1 col-md-6">
                                ...
                                <div class="d-flex g-3">
                                    <select class="js-example-basic-multiple form-select affiliator_select"
                                ...
                                <div class="d-flex g-3">
                                    <select class="js-example-basic-multiple form-select affiliator_select"
                                        multiple="multiple" data-width="100%" onchange="errorRemove(this);">
                                        @foreach ($saleCommisions as $saleCommision)
                                            <option value="{{ $saleCommision->id }}">{{ $saleCommision->name }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="card-body">
                    ...
                    <div class="row show_customer_details">
                        <div class="col-lg-12 d-flex justify-content-between align-items-center">
                            ...
                            <span>:</span>
                            <label for="exampleInputUsername2" class="col-form-label">null<b>
                                </b></label>
                        </div>
                        <div class="col-lg-12 d-flex justify-content-between align-items-center">
    ...
    {{-- table  --}}
    <div class="row">
        <div class="{{ $warranty_status == 1 ? 'col-lg-12' : 'col-lg-8' }}  mb-1 grid-margin stretch-card">
            <div class="card">
                <div class="card-body px-4 py-2">
                    <div class="mb-3">
        ...
        <div class="{{ $warranty_status == 1 ? 'col-lg-5' : 'col-lg-4' }} mb-1 grid-margin stretch-card">
            <div class="card">
                <div class="card-body px-4 py-2">
                    ...
                    <div class="row align-items-center mb-2 previous_due_field ">
                        ...
                        <div class="col-sm-8 text-end">
                            <input type="number" class="form-control invoice_total border-0 text-end" name="grand_total"
                                readonly value="0.00" />
                        </div>
                    </div>
                    ...
                    <div class="my-3">
                        <button class="btn btn-primary payment_btn"><i class="fa-solid fa-money-check-dollar"></i>
                            Make Invoice</button>
                        <button class="btn btn-primary draft_invoice"><i class="fa-solid fa-file-lines"></i>
    ...
    <script>
        ...
        // console.log("Sortable available:", typeof $.fn.sortable === "function" ? "Yes" : "No");
        if (drag_and_drop === "1") {
    ...
    <script src="{{ asset('custom/js/sale.js') }}"></script>
