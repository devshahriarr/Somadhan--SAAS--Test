...
@section('admin')
    ...
    <label for="offcanvas-toggle"
        style="position: fixed; font-size:20px; top: 65px; right: 20px; z-index: 1000; cursor: pointer;">
        ...
        <div class="card">
            <div class="card-body px-4 py-0">
                <div class="row pt-2">
                    ...
                    @if ($affiliateProgram)
                    <div class="mb-1 col gap-2">
                        @php
                            $affiliators = \App\Models\Affiliator::where('branch_id', Auth::user()->branch_id)
                            ->whereNull('user_id')
                            ->get();
                            $saleCommisions = \App\Models\Affiliator::where('branch_id', Auth::user()->branch_id)
                    ...
                    <div class="mb-1 col d-flex gap-2">
                ...
                <div class="row ">
                    @if ($barcode == 1)
                    <div class="mb-2 col-md-6 d-flex gap-2">
                        <label for="ageSelect" class="form-label">Barcode</label>
                        <div class="input-group">
                            <div style="height:30px" class="input-group-text" id="btnGroupAddon"><i class="fa-solid fa-barcode"></i>
                            </div>
                    ...
                    <div class="mb-1 col-md-6 d-block">
                        <div class="d-flex g-3" style="width: -webkit-fill-available;">
                        ...
                        <div class="show_customer_details">
                            <div class="col-12 d-flex align-items-center">
                                <label for="exampleInputUsername2" class="col-form-label">Previous Due</label>
                                <span> : </span>
                                <label for="exampleInputUsername2" class="col-form-label text-danger px-4"><b>
                                    </b> 00</label>
                            </div>
                        </div>
                    </div>
...
<div class="invoice-footer-container mt-4 " style="font-size: 12px">
    <div class="card fixed-footer px-2 py-1">
        <div class="card-body px-2 py-2">
            <div class="d-flex flex-nowrap align-items-center justify-content-start overflow-auto">
                ...
                <div class="d-block col-md-3">
                    ...
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input type="number" class="form-control total border-0 text-end" style="width: 120px;" name="total" readonly value="0.00" />
                    </div>
                ...
                <div class="d-flex align-items-center nowrap-item">
                    ...
                    <input type="number" class="form-control previous_due border-0 text-end" style="width: 120px;" name="previous_due" readonly value="0.00" />
                </div>

                <!-- Grand Total -->
                <div class="d-flex align-items-center nowrap-item">
                    <span class="me-2">Grand Total:</span>
                    <input type="number" class="form-control grandTotal border-0 text-end" style="width: 120px;" name="" readonly value="0.00" />
                </div>
                @else
                ...
                <div class="d-block col-md-3">
                    ...
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input class="form-control form-control-sm total_payable text-end" style="width: 120px; border:1px solid #1761D1" minlength="0" name="total_payable" type="number" value="" />
                    </div>
                    ...
                    <div class="d-flex align-items-center nowrap-item">
                        ...
                        <input type="number" class="form-control total_due border-0 text-end"  style="width: 120px;" name="" readonly value="0.00" />
                    </div>
                </div>

                <div class="col-md-3 d-block nowrap-item">
                    <!-- Transaction Method -->
                    <div class="d-flex align-items-center nowrap-item mb-1">
                ...
                <div class="col-sm-6 d-none">
                    <div class="mb-3 form-valid-groups">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" {{ $mode->sale_page == 1 ? 'checked' : '' }}
